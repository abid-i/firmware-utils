...
#define SOFT_VER_NUMERIC(_maj, _min, _patch)                                   \
  {                                                                            \
    .type = SOFT_VER_TYPE_NUMERIC, .num = { _maj, _min, _patch }               \
  }
 ...
 * endian UINT32 size, followed by that number of bytes containing (text) data.
...
#define SAFELOADER_PAYLOAD_OFFSET                                              \
  (SAFELOADER_PREAMBLE_SIZE + SAFELOADER_HEADER_SIZE)
...
static struct device_info boards[] = {
    /** Firmware layout for the CPE210/220 V1 */
    {
        ...
        .partitions = {{"fs-uboot", 0x00000, 0x20000},
    ...
    /** Firmware layout for the CPE710 V1 */
    {
        ...
        .partitions = {{"fs-uboot", 0x00000, 0x50000},
    ...
    {.id = "AD7200",
     ...
     .partitions = {{"SBL1", 0x00000, 0x20000},
     ...
     */
     .partitions = {{"SBL1", 0x00000, 0x20000},
                    ...
                    {"radio", 0x1b0000, 0x40000},
                    {"os-image", 0x1f0000,
                     0x400000}, /* Stock: base 0x1f0000 size 0x200000 */
                    {"file-system", 0x5f0000,
                     0x1900000}, /* Stock: base 0x3f0000 size 0x1b00000 */
                    {"default-mac", 0x1ef0000, 0x00200},
                    {"pin", 0x1ef0200, 0x00200},
    ...
    /** Firmware layout for the A7-V5 */
    {
        ...
        .partitions =
            {{"factory-boot", 0x00000, 0x20000},
             ...
             {"firmware", 0x40000,
              0xec0000}, /* Stock: name os-image base 0x40000 size 0x120000 */
    ...
    /** Firmware layout for the Archer A9 v6 */
    {
        ...
        .partitions =
            {{"factory-boot", 0x00000, 0x20000},
             ...
             {"firmware", 0xc0000,
              0xf00000}, /* Stock: name os-image base 0xc0000 size 0x120000 */
    ...
    /** Firmware layout for the Archer AX23 v1 */
    {
        ...
        .support_list =
            ...
            "{product_name:Archer "
            "AX1800,product_ver:1.20,special_id:45550000}\n"
            "{product_name:Archer "
            "AX1800,product_ver:1.20,special_id:52550000}\n",
        .part_trail = 0x00,
        .soft_ver = SOFT_VER_TEXT("soft_ver:3.0.3\n"),

        .partitions = {{"fs-uboot", 0x00000, 0x40000},
    ...
    /** Firmware layout for the C2v3 */
    {
        ...
        .partitions = {{"factory-boot", 0x00000, 0x20000},
    ...
    /** Firmware layout for the C25v1 */
    {
        ...
        .partitions =
            {{"factory-boot", 0x00000, 0x20000},
             {"fs-uboot", 0x20000, 0x10000},
             {"firmware", 0x30000,
              0x7a0000}, /* Stock: name os-image base 0x30000 size 0x100000 */
    ...
    /** Firmware layout for the C58v1 */
    {
        ...
        .support_list = "SupportList:\r\n"
                        "{product_name:Archer "
                        "C58,product_ver:1.0.0,special_id:00000000}\r\n"
                        "{product_name:Archer "
                        "C58,product_ver:1.0.0,special_id:45550000}\r\n"
                        "{product_name:Archer "
                        "C58,product_ver:1.0.0,special_id:55530000}\r\n",
        .part_trail = 0x00,
        .soft_ver = SOFT_VER_TEXT("soft_ver:1.0.0\n"),

        .partitions = {{"fs-uboot", 0x00000, 0x10000},
    ...
    /** Firmware layout for the C59v1 */
    {
        ...
        .support_list = "SupportList:\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:1.0.0,special_id:00000000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:1.0.0,special_id:43410000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:1.0.0,special_id:45550000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:1.0.0,special_id:52550000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:1.0.0,special_id:55530000}\r\n",
        .part_trail = 0x00,
        .soft_ver = SOFT_VER_TEXT("soft_ver:1.0.0\n"),
    ...
    /** Firmware layout for the C59v2 */
    {
        ...
        .support_list = "SupportList:\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:2.0.0,special_id:00000000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:2.0.0,special_id:43410000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:2.0.0,special_id:45550000}\r\n"
                        "{product_name:Archer "
                        "C59,product_ver:2.0.0,special_id:55530000}\r\n",
        .part_trail = 0x00,
    ...
    /** Firmware layout for the C60v1 */
    {
        ...
        .support_list = "SupportList:\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:1.0.0,special_id:00000000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:1.0.0,special_id:43410000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:1.0.0,special_id:45550000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:1.0.0,special_id:55530000}\r\n",
        .part_trail = 0x00,
        .soft_ver = SOFT_VER_TEXT("soft_ver:1.0.0\n"),
    ...
    /** Firmware layout for the C60v2 */
    {
        ...
        .support_list = "SupportList:\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:2.0.0,special_id:42520000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:2.0.0,special_id:43410000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:2.0.0,special_id:45550000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:2.0.0,special_id:55530000}\r\n",
        .part_trail = 0x00,
        .soft_ver = SOFT_VER_TEXT("soft_ver:2.0.0\n"),

        .partitions = {{"factory-boot", 0x00000, 0x1fb00},
    ...
    /** Firmware layout for the C60v3 */
    {
        ...
        .support_list = "SupportList:\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:3.0.0,special_id:42520000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:3.0.0,special_id:43410000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:3.0.0,special_id:45550000}\r\n"
                        "{product_name:Archer "
                        "C60,product_ver:3.0.0,special_id:55530000}\r\n",
        .part_trail = 0x00,
    ...
    {.id = "ARCHER-C5-V2",
     .vendor = "",
     .support_list = "SupportList:\r\n"
                     "{product_name:ArcherC5,product_ver:2.0.0,special_id:"
                     "00000000}\r\n"
                     "{product_name:ArcherC5,product_ver:2.0.0,special_id:"
                     "55530000}\r\n"
                     "{product_name:ArcherC5,product_ver:2.0.0,special_id:"
    ...
    /** Firmware layout for the Deco M4R v1 and v2 */
    {
        ...
        .partitions = {{"fs-uboot", 0x00000, 0x80000},
    ...
    },
{
        ...
        .support_list =
            "SupportList:\r\n"
            "product-name:M4R,product-ver:3.0.0,special-id:55530000\r\n"  /* US */
            "product-name:M4R,product-ver:3.0.0,special-id:45550000\r\n"  /* EU */  
            "product-name:M4R,product-ver:3.0.0,special-id:43410000\r\n"  /* CA */
            "product-name:M4R,product-ver:3.0.0,special-id:4A500000\r\n"  /* JP */
            "product-name:M4R,product-ver:3.0.0,special-id:41550000\r\n"  /* AU */
            "product-name:M4R,product-ver:3.0.0,special-id:4B520000\r\n"  /* BR */
            "product-name:M4R,product-ver:3.0.0,special-id:54570000\r\n"  /* TW */
            "product-name:M4R,product-ver:3.0.0,special-id:42340000\r\n", /* CN */
        
        .part_trail = PART_TRAIL_FF,
        /* Updated soft version to match current OpenWrt for proper validation */
        .soft_ver = SOFT_VER_TEXT("soft-ver:24.10.3 Build $(shell date +%Y%m%d) Rel.00000"),
        
        /* CRITICAL: Set to Cloud type for proper handling */
        // .type = SAFELOADER_TYPE_CLOUD,
        
        /* Partition layout combining slot 1 (kernel + rootfs) + unused space
        * Total available: 0x1fc0000 - 0x1020000 = 0xfa0000 (15.625MB) */
        .partitions = {
            /* Critical partitions - NEVER MODIFY */
            ...
            /* Configuration partitions - maintain stock layout */
            ...
            /* SLOT 0 - Keep separate for stock firmware recovery */
            ...
            /* SLOT 1 - Combined firmware partition for OpenWrt
            * MTD splitter will automatically separate os-image@1(kernel)/file-system@1(rootfs) */
        ...
        .partition_names = {
            ...
            // .file_system = "firmware", /* Same as os_image for combined */
        },
    ...
    {.id = "DECO-M5",
     ...
     .partitions = {{"SBL1", 0x00000, 0x30000},
                    {"boot-config_0", 0x30000, 0x10000},
                    {"MIBIB", 0x40000, 0x10000},
                    {"boot-config_1", 0x50000, 0x10000},
                    {"QSEE", 0x60000, 0x60000},
    ...
    {.id = "EAP245-V3",
     ...
     .partitions = {{"factroy-boot", 0x00000, 0x40000},
    ...
    {.id = "TL-WPA8630P-V2.0-EU",
     ...
     .partitions = {{"factory-uboot", 0x00000, 0x20000},
                    {"fs-uboot", 0x20000, 0x20000},
    ...
    {.id = "RE350K-V1",
     .vendor = "",
     .support_list = "SupportList:\n"
                     "{product_name:RE350K,product_ver:1.0.0,special_id:"
                     "00000000,product_region:US}\n",
     .part_trail = 0x00,
     .soft_ver = SOFT_VER_DEFAULT,
...
init_meta_partition_entry(const char *name, const void *data, uint32_t data_len,
  ...
  struct image_partition_entry entry = {
      .name = name, .size = total_len, .data = malloc(total_len)};
  if (!entry.data)
...
static struct image_partition_entry
make_partition_table(const struct device_info *p) {
  struct image_partition_entry entry = alloc_image_partition(
      p->partition_names.partition_table, SAFELOADER_PAYLOAD_TABLE_SIZE);
  ...
  *(s++) = 0x00;
  ...
  for (i = 0; p->partitions[i].name; i++) {
    ...
    size_t w = snprintf(s, len, "partition %s base 0x%05x size 0x%05x\n",
                        p->partitions[i].name, p->partitions[i].base,
                        p->partitions[i].size);
...
/** Generates a binary-coded decimal representation of an integer in the range
 * [0, 99] */
static inline uint8_t bcd(uint8_t v) { return 0x10 * (v / 10) + v % 10; }

/** Generates the soft-version partition */
static struct image_partition_entry
make_soft_version(const struct device_info *info, uint32_t rev) {
  ...
  struct soft_version s = {.pad1 = 0xff,
  ...
  if (info->soft_ver_compat_level == 0)
    return init_meta_partition_entry(
        info->partition_names.soft_ver, &s,
        (uint8_t *)(&s.compat_level) - (uint8_t *)(&s), info->part_trail);
  else
...
static struct image_partition_entry
make_support_list(const struct device_info *info) {
  uint32_t len = strlen(info->support_list);
  return init_meta_partition_entry(info->partition_names.support_list,
                                   info->support_list, len, info->part_trail);
}

/** Partition with extra-para data */
static struct image_partition_entry
make_extra_para(const struct device_info *info, const uint8_t *extra_para,
                size_t len) {
  return init_meta_partition_entry(info->partition_names.extra_para, extra_para,
                                   len, info->part_trail);
}

/** Creates a new image partition with an arbitrary name from a file */
static struct image_partition_entry
read_file(const char *part_name, const char *filename, bool add_jffs2_eof,
          struct flash_partition_entry *file_system_partition) {
  struct stat statbuf;
  ...
  if (add_jffs2_eof) {
    if (file_system_partition)
      len = ALIGN(len + file_system_partition->base, 0x10000) +
  ...
  if (add_jffs2_eof) {
    ...
    memcpy(end - sizeof(jffs2_eof_mark), jffs2_eof_mark,
...
/**
   Copies a list of image partitions into an image buffer and generates the
   image partition table while doing so
   ...
   The firmware image must contain at least the partition-table and support-list
   partitions to be accepted. There aren't any alignment constraints for the
   image partitions.

   The partition-table partition contains the actual flash layout; partitions
   from the image partition table are mapped to the corresponding flash
   partitions during the firmware upgrade. The support-list partition contains a
   list of devices supported by the firmware image.
...
*/
static void put_partitions(uint8_t *buffer,
                           const struct flash_partition_entry *flash_parts,
                           const struct image_partition_entry *parts) {
  size_t i, j;
  char *image_pt = (char *)buffer,
       *end = image_pt + SAFELOADER_PAYLOAD_TABLE_SIZE;
  ...
  for (i = 0; parts[i].name; i++) {
    for (j = 0; flash_parts[j].name; j++) {
      if (!strcmp(flash_parts[j].name, parts[i].name)) {
        if (parts[i].size > flash_parts[j].size)
          error(1, 0, "%s partition too big (more than %u bytes)",
                flash_parts[j].name, (unsigned)flash_parts[j].size);
        break;
      }
    }
    ...
    size_t w =
        snprintf(image_pt, len, "fwup-ptn %s base 0x%05x size 0x%05x\t\r\n",
...
/**
   ...
   Image format:
     ...
     0004-0013    MD5 hash (hash of a 16 byte salt and the image data starting
   with byte 0x14) 0014-0017    Vendor information length (without padding) (4
   bytes, big endian) 0018-1013    Vendor information (4092 bytes, padded with
   0xff; there seem to be older (VxWorks-based) TP-LINK devices which use a
   smaller vendor information block) 1014-1813    Image partition table (2048
   bytes, padded with 0xff) 1814-xxxx    Firmware partitions
*/
static void *generate_factory_image(struct device_info *info,
                                    const struct image_partition_entry *parts,
                                    size_t *len) {
  *len = SAFELOADER_PAYLOAD_OFFSET + SAFELOADER_PAYLOAD_TABLE_SIZE;
  ...
  put_md5(image + 0x04, image + SAFELOADER_PREAMBLE_SIZE,
          *len - SAFELOADER_PREAMBLE_SIZE);
...
/**
   ...
   This makes some assumptions about the provided flash and image partition
   tables and should be generalized when TP-LINK starts building its safeloader
   into hardware with different flash layouts.
*/
static void *
generate_sysupgrade_image(struct device_info *info,
                          const struct image_partition_entry *image_parts,
                          size_t *len) {
  size_t i, j;
  ...
  for (i = 0; info->partitions[i].name; i++) {
    ...
    } else if (!strcmp(info->partitions[i].name,
                       info->last_sysupgrade_partition)) {
  ...
  *len = flash_last_partition->base - flash_first_partition->base +
         image_last_partition->size;
    ...
    for (j = 0; image_parts[j].name; j++) {
      if (!strcmp(info->partitions[i].name, image_parts[j].name)) {
        if (image_parts[j].size > info->partitions[i].size)
          error(1, 0, "%s partition too big (more than %u bytes)",
                info->partitions[i].name, (unsigned)info->partitions[i].size);
        memcpy(image + info->partitions[i].base - flash_first_partition->base,
               image_parts[j].data, image_parts[j].size);
        break;
      }
...
static void build_image(const char *output, const char *kernel_image,
                        const char *rootfs_image, uint32_t rev,
                        bool add_jffs2_eof, bool sysupgrade,
  ...
  if (firmware_partition) {
    ...
    if (!sysupgrade)
      file_system_partition->base =
          ALIGN(firmware_partition->base + kernel.st_size, 0x10000);

    file_system_partition->size =
        firmware_partition->size - file_system_partition->base;
  ...
  parts[3] =
      read_file(info->partition_names.os_image, kernel_image, false, NULL);
  ...
  if (strcasecmp(info->id, "ARCHER-A6-V3") == 0 ||
    ...
    parts[5] = make_extra_para(info, extra_para, sizeof(extra_para));
...
static void usage(const char *argv0) {
  fprintf(
      ...
      "  -z <file>       convert an oem firmware into a sysupgade file. Use -o "
      "for output file\n",
      argv0);
};
...
static int add_flash_partition(struct flash_partition_entry *part_list,
                               size_t max_entries, const char *name,
                               unsigned long base, unsigned long size) {
  size_t ptr;
  /* check if the list has a free entry */
  for (ptr = 0; ptr < max_entries; ptr++, part_list++) {
    if (part_list->name == NULL && part_list->base == 0 && part_list->size == 0)
      break;
  }
...
static int read_partition_table(FILE *file, long offset,
                                struct flash_partition_entry *entries,
                                size_t max_entries, int type) {
  ...
  while ((ptr + strlen(parthdr)) < end &&
    ...
    end_part = memchr(ptr, '\n', (end - ptr));
    if (end_part == NULL) {
      /* in theory this should never happen, because a partition always ends
       * with 0x09, 0x0D, 0x0A */
      break;
    }
...
static void safeloader_parse_image(FILE *input_file,
                                   struct safeloader_image_info *image) {
...
static void write_partition(FILE *input_file, size_t firmware_offset,
                            struct flash_partition_entry *entry,
                            FILE *output_file) {
  char buf[4096];
  size_t offset;
...
static int extract_firmware_partition(FILE *input_file, size_t firmware_offset,
                                      struct flash_partition_entry *entry,
...
static int extract_firmware(const char *input, const char *output_directory) {
  ...
  if ((statbuf.st_mode & S_IFMT) != S_IFDIR) {
    error(1, errno, "Given output directory is not a directory %s",
          output_directory);
  }
  ...
  for (size_t i = 0; i < MAX_PARTITIONS && info.entries[i].name; i++)
    extract_firmware_partition(input_file, info.payload_offset,
                               &info.entries[i], output_directory);

  return 0;
}

static struct flash_partition_entry *
find_partition(struct flash_partition_entry *entries, size_t max_entries,
...
static int firmware_info(const char *input) {
  ...
  if (e) {
    ...
    safeloader_read_partition(input_file, info.payload_offset + e->base, e,
                              &part);
  ...
  if (e) {
    ...
    if (read_partition_table(input_file, flash_table_offset, parts,
...
static void convert_firmware(const char *input, const char *output) {
  ...
  fwup_os_image =
      find_partition(info.entries, MAX_PARTITIONS, "os-image",
                     "Error can not find os-image partition (fwup)");
  fwup_file_system =
      find_partition(info.entries, MAX_PARTITIONS, "file-system",
                     "Error can not find file-system partition (fwup)");
  fwup_partition_table =
      find_partition(info.entries, MAX_PARTITIONS, "partition-table",
                     "Error can not find partition-table partition");
  ...
  flash_os_image =
      find_partition(flash, MAX_PARTITIONS, "os-image",
                     "Error can not find os-image partition (flash)");
  flash_file_system =
      find_partition(flash, MAX_PARTITIONS, "file-system",
                     "Error can not find file-system partition (flash)");
  ...
  write_partition(input_file, info.payload_offset, fwup_file_system,
                  output_file);
...
int main(int argc, char *argv[]) {
  ...
  if (info_image) {
    ...
    if (!extract_image)
      error(1, 0,
            "No factory/oem image given via -x <file>. Output directory is "
            "only valid with -x");
    if (!output_directory)
      error(1, 0,
            "Can not extract an image without output directory. Use -d <dir>");
    extract_firmware(extract_image, output_directory);
  } else if (convert_image) {
    if (!output)
      error(1, 0,
            "Can not convert a factory/oem image into sysupgrade image without "
            "output file. Use -o <file>");
    ...
    build_image(output, kernel_image, rootfs_image, rev, add_jffs2_eof,
                sysupgrade, info);
  }
